...
export const DEFAULT_TERMS: ContractTerms = {
  ...
  scheduling_text:
    "Work is estimated to begin within 5 business days of contract signing, weather permitting. The Contractor shall not be held liable for delays caused by inclement weather, material shortages, permit delays, or other circumstances beyond the Contractor's reasonable control. The Contractor will communicate any anticipated delays to the Customer promptly.",
  hidden_damage_text:
  ...
  subcontractors_text:
    "The Contractor reserves the right to employ qualified subcontractors to perform portions of the work described herein. The Contractor shall remain fully responsible for the quality and timeliness of all work performed by subcontractors.",
  warranty_text:
    "The Contractor warrants all workmanship for the period specified below from the date of completion. Manufacturer warranties on materials shall apply as provided by the manufacturer. This warranty does not cover damage caused by acts of nature, neglect, or unauthorized modifications.",
  warranty_years: 5,
  inspection_text:
    "Upon completion of all work, the Contractor and Customer shall conduct a final walkthrough inspection. Any deficiencies identified during the inspection shall be corrected by the Contractor within a reasonable timeframe at no additional cost. The Customer agrees to make final payment upon satisfactory completion of the inspection.",
