              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {PLACEHOLDER_TOKENS.map((token) => (
                  <span
                    ...
                    className="cursor-pointer px-2 py-0.5 rounded bg-blue-500/10 text-blue-600 text-xs border border-blue-500/20 hover:bg-blue-500/20 transition"
                  >
                    {token}
                  </span>
                ))}
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="inline-block px-2 py-0.5 rounded bg-blue-500/10 text-blue-600 text-xs font-medium">
                ...
                <div className="flex items-center gap-2 ml-4 shrink-0">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg hover:bg-red-500/10 text-foreground/60 hover:text-red-600 transition"
                    title="Delete"
                  >
