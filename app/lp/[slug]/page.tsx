...
export default function LandingPageView() {
  ...
  const renderTitle = () => {
    if (page.city && page.title.includes(page.city)) {
      const html = page.title.replace(
        page.city,
              ...
              {step === "form" ? (
                <div className="rounded-2xl border border-gray-800 bg-gray-900 p-6 sm:p-8 ring-1 ring-amber-500/30 shadow-lg shadow-amber-500/10">
                  ...
                  <p className="text-sm text-center text-gray-400 mt-1 mb-6">
                    No commitment. No spam. Just a free quote.
                  </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-start gap-3 cursor-pointer pt-1">
                      <input
                        ...
                        className="mt-0.5 h-4 w-4 flex-shrink-0 rounded border-gray-600 bg-gray-800 accent-teal-500"
                      />
                      <span className="text-[11px] leading-relaxed text-gray-400">
                        ...
                        <a href="/privacy" className="underline hover:text-gray-300" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
                        {" "}and{" "}
                        <a href="/terms" className="underline hover:text-gray-300" target="_blank" rel="noopener noreferrer">Terms of Service</a>.
                      </span>
                    </label>
                    ...
                    <button
                      ...
                      className="w-full rounded-xl py-3.5 text-sm font-bold text-white transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:brightness-110"
