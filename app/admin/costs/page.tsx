...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  marketing: "bg-amber-500/15 text-amber-600 border-amber-500/30",
  labor: "bg-emerald-500/15 text-emerald-600 border-emerald-500/30",
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        <div className="rounded-2xl border border-border bg-card p-4 shadow-sm">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-500/15 text-emerald-600"><DollarSign className="h-4 w-4" /></div>
        ...
        <div className="rounded-2xl border border-border bg-card p-4 shadow-sm">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-red-500/15 text-red-600"><DollarSign className="h-4 w-4" /></div>
        ...
        <div className="rounded-2xl border border-border bg-card p-4 shadow-sm">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-amber-500/15 text-amber-600"><Percent className="h-4 w-4" /></div>
        ...
        <div className="rounded-2xl border border-border bg-card p-4 shadow-sm">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-500/15 text-blue-600"><Users className="h-4 w-4" /></div>
              ...
              <tbody>
                {costs.map(c => (
                  <tr key={c.id} className="border-b border-border/50 hover:bg-secondary/30">
                    ...
                    <td className="py-2.5 pr-4 font-medium text-red-600">${c.monthly_cost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                    ...
                    <td className="py-2.5">
                      <div className="flex gap-1">
                        ...
                        <button onClick={() => handleDelete(c.id)} className="rounded-lg p-1 text-muted-foreground hover:bg-red-500/20 hover:text-red-600"><Trash2 className="h-3.5 w-3.5" /></button>
                      </div>
                    </td>
                  </tr>
                ))}
                ...
                <tr className="border-t-2 border-border">
                  ...
                  <td className="py-2.5 pr-4 font-bold text-red-600">
