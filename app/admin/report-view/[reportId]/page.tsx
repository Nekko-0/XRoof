    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl print:max-w-none print:mx-0">
        <div className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden print:border-none print:shadow-none print:rounded-none">
          {/* Green accent bar */}
          <div className="h-2 bg-primary print:bg-[#1b5e20]" />
          ...
          <div className="p-8 print:p-10 print:text-black print:bg-white">
            ...
            <div className="mb-8 flex items-start justify-between">
              ...
              <div className="text-right">
                <p className="text-lg font-bold text-primary print:text-[#1b5e20]">ROOF ESTIMATE</p>
            ...
            {report.scope_of_work && (
              <div className="mb-6">
                <h3 className="mb-2 text-sm font-bold uppercase tracking-wider text-primary print:text-[#1b5e20]">
                  Scope of Work
                </h3>
            ...
            {report.price_quote != null && (
              <div className="mb-6">
                ...
                <div className="rounded-lg border-2 border-primary/30 bg-primary/5 p-4 print:border-[#1b5e20]/30 print:bg-green-50">
